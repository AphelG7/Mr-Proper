...
GOOS=windows GOARCH=386 go build -o ../../../../../bin/Mr-Proper/MrProper_linux_win32 github.com/4m4rOk/Mr-Proper/listener.exe
echo "Building listener for windows amd64..."
GOOS=windows GOARCH=amd64 go build -o ../../../../../bin/Mr-Proper/MrProper_win64 github.com/4m4rOk/Mr-Proper/listener.exe
