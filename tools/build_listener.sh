...
GOOS=windows GOARCH=386 go build -o ../../../../../bin/Mr-Proper/MrProper_linux_win32.exe github.com/4m4rOk/Mr-Proper/listener
echo "Building listener for windows amd64..."
GOOS=windows GOARCH=amd64 go build -o ../../../../../bin/Mr-Proper/MrProper_win64.exe github.com/4m4rOk/Mr-Proper/listener
